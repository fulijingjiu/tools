...
const output = computed(() => {
  ...
  const result = mode.value === 'encode' ? encodeBase64(input.value) : decodeBase64(input.value)
...
<template>
  <ToolLayout title="Base64 编解码" description="在普通文本和 Base64 字符串之间转换，支持中文。">
    <div class="space-y-4">
      <TextInput v-model="input" placeholder="输入文本或 Base64 字符串..." />
